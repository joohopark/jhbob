...
## IOS App 개발자가 자주가보면 좋은 Reference..
...
- [API Design Guidelines, 애플이 원하는 개발 스타일](https://swift.org/documentation/api-design-guidelines/)
- [Swift Style Guide, 레이웬더위치가 주장하는 개발 스타일](https://github.com/raywenderlich/swift-style-guide)
...
- [Swift Korea Facebook Group, 개인적으로 페북을 안해서...](https://www.facebook.com/groups/swiftkor/)
...
- [아이폰 데브, 새글 리젠은 잘 안되지만... 일단은 다 한글이라 맘에 듬..](http://iphonedev.co.kr)
